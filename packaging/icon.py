...
silhouette. So: a dark ground, pale wings held out to either side, and a body
dark enough to be a shape rather than a picture.
...
def png(path, w, h, rows):
    ...
    head = struct.pack(">IIBBBBB", w, h, 8, 2, 0, 0, 0)  # 8-bit truecolour
...
def shade(x, y):
    """Colour at a point in 0..SIZE space."""
    # The plate. macOS wants the rounded square baked in.
    inset = SIZE * 0.055
